...
import eu.kanade.tachiyomi.data.track.mangadex.MangaDexTracker
...
class TrackerManager {
    ...
    val mangaDex = MangaDexTracker(MANGADEX)

    val trackers = listOf(myAnimeList, aniList, kitsu, shikimori, bangumi, komga, mangaUpdates, kavita, suwayomi, mangaDex)
